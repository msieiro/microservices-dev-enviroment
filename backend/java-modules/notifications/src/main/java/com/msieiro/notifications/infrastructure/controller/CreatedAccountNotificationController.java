...
public record CreatedAccountNotificationController(
    CreatedAccountNotificationService createdAccountNotificationService) {

    @PostMapping
    public ResponseEntity<?> sendNotificationToCreatedAccount(@RequestBody CreatedAccountNotificationRequest notificationRequest) {
